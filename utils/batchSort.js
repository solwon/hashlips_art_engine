...
for (let i = 0; i < 2; i++) {
    for (let j = 0; j < buildTypeNums[i]; j++) {
        ...
        const orders = ['Background', 'Divine Protection', 'Sign', 'Fur', 'Tabby', 'Clothing', 'Accesory', 'Eyes', 'Eyeware', 'Mouth'];
        ...
        const layersSetup = (layersOrder) => {
            ...
            for (const obj of layersOrder) {
                ...
                if (obj == 'Accesory') {
                    if (earFlag) {
                        objName = 'Accesory_YesEars';
                    } else {
                        objName = 'Accesory_NoEars';
                    }
                }
                if (obj == 'Divine Protection') {
                    objName = 'Divine_Protection';
                }
